...
fun main() {
    val post = Post(
        ...
        content = """
            В 2004 году или около того Майкл Физерс прислал мне электронное письмо, в котором сообщил, что если переупорядочить мои принципы, из их первых букв можно составить слово SOLID — так появились принципы SOLID. Последующие главы подробнее описывают каждый принцип, а пока познакомьтесь с краткой аннотацией:
    ...
    // Здесь можно протестировать отправку сообщения, задавая ключ action'а
    val sendingAction = "NEW_POST"
